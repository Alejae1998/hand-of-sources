...
describe('backend-express-template routes', () => {
  ...
  it('PUT /classes/:id should update a list class', async () => {
  ...
  it('DELETE /classes/:id should delete a list class', async () => {
